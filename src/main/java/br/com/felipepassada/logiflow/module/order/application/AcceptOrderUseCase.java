...
public class AcceptOrderUseCase {
    ...
    public AcceptOrderUseCase(OrderRepository orderRepository, DriverRepository driverRepository, SecurityUtils securityUtils) {
    ...
    public void execute(UUID orderId) throws DomainException {
        ...
        orderJpa.setStatus(OrderStatus.PICKING_UP);
